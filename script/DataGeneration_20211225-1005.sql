...
-- Script date 12/25/2021 10:05:18 AM
...
--
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'1', N'Khắc Thành', 'Lý Chính Thắng', 'Reinaldo_Goforth@nowhere.com', '03416761826')
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'2', N'im Xuyến', 'Trường Chinh', 'Arden.Mcmillen@nowhere.com', '03304618012')
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'7', N'Hoàng Cúc', 'An Dương Vương', 'etadog2515@example.com', '03006932389')
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'0', N'Quang Trọng', 'Hùng Vương', 'JessHuntington@example.com', '03759737214')
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'9', N'Tịnh Yên', 'Cách Mạng Tháng 8', 'Knott@nowhere.com', '03478882778')
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'4', N'Ngọc Quế', 'Nguyễn Trãi', 'fmtskgwn_mpjfo@example.com', '03308602792')
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'5', N'Vũ Anh', 'Nguyễn Văn Cừ', 'Smoot14@nowhere.com', '03378839238')
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'8', N'Lâm Tường', 'Cộng Hòa', 'RyanAnders7@example.com', '03745028257')
INSERT dbo.NHANVIEN(MANV, HOTEN, DIACHI, EMAIL, SDT) VALUES (N'6', N'im Xuân', 'Âu Cơ', 'SungAlvarez@nowhere.com', '03747053445')
GO
...
--
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'43757', 'Outdoors', N'Nguyễn Văn Cừ', N'3', N'Jamie', N'Quang Trọng', N'Hồ Chí Minh', '03364624545', 'Alexia_Dobbins8@example.com', 953)
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'33847', 'Beauty', N'Trần Hưng Đạo', N'Thanh Xuân', N'Pedro', N'Lâm Tường', N'Hà Nội', '03029468595', 'vnlx5987@nowhere.com', 81)
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'23248', 'Sports', N'Lê Lợi', N'Thủ Đức', N'Toney', N'Quang Trung', N'Hồ Chí Minh', '03488852176', 'Allen@example.com', 578)
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'03317', 'Computers', N'Lê Lai', N'Cầu Giấy', N'Emil', N'Dã Lâm', N'Hà Nội', '03449437735', 'Bradbury@example.com', 219)
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'38549', 'Furniture', N'Nguyễn Trãi', N'Phú Tài', N'Rolland', N'Lâm Viên', N'Phan Thiết', '03350132113', 'Marci_Peterson485@example.com', 861)
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'88873', 'Patio', N'An Dương Vương', N'Tam Hiệp', N'Lamar', N'Việt Hà', N'Biên Hòa', '03703208756', 'Tristan.Mcgregor65@example.com', 308)
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'67586', 'Food', N'Nguyễn Thị Minh Khai', N'9', N'Amado', N'Thu Ngọc', N'Hồ Chí Minh', '03704647420', 'fjfn7678@nowhere.com', 764)
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'49858', 'Electronics', N'Hùng Vương', N'7', N'Carey', N'Việt Hương', N'Hồ Chí Minh', '03758591266', 'Abrams@nowhere.com', 3)
INSERT dbo.DoanhNghiep(MaSoThue, LoaiHang, DiaChiKinhDoanh, QUAN, TenDoanhNghiep, NguoiDaiDien, ThanhPho, SoDT, Email, SLDonHang) VALUES (N'00216', 'Outdoors', N'Trường Chinh', N'Đống Đa', N'Dario', N'Công Luật', N'Hà Nội', '03373239158', 'Arndt@example.com', 663)
GO
...
--
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'1', N'38549', '6', 657860, '4')
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'8', N'43757', '2', 131066, '8')
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'9', N'88873', '7', 326546, '4')
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'0', N'33847', '9', 1207186, '3')
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'2', N'67586', '7', 2435890, '2')
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'4', N'23248', '4', 641739, '5')
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'7', N'49858', '1', 2204419, '0')
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'6', N'03317', '6', 2606573, '5')
INSERT dbo.ChiNhanh(MACHINHANH, MaDoanhNghiep, DiaChi, DoanhSoBan, MAHOPDONG) VALUES (N'3', N'00216', '5', 1970220, '7')
GO
