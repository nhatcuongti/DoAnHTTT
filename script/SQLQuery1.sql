...
CREATE DATABASE Nhom18_DoAnThucHanh_19HTT2_1
GO
...
CREATE TABLE DoanhNghiep(
  ...
  Email VARCHAR(50) NOT NULL UNIQUE,
  SLDonHang INT CHECK(SLDonHang >=0 AND SLDonHang <= 1000)
...
CREATE TABLE HopDong(
  ...
  NguoiDaiDien NVARCHAR(50) NOT NULL,
  SoChiNhanhDK INT CHECK (SoChiNhanhDK >=0 AND SoChiNhanhDK <=10) NOT NULL,
  HieuLuc INT CHECK(HieuLuc >=0 AND HieuLuc <= 12) NOT NULL,
  PhanTramHH FLOAT CHECK (0 < PhanTramHH and PhanTramHH <= 1 ) NOT NULL,
  NgayBatDau DATE NOT NULL,
  MaDoanhNghiep VARCHAR(50) NOT NULL,
  DangGiaHan BIT DEFAULT 'TRUE',
  PRIMARY KEY(MaHD)
);
GO
...
ALTER TABLE Nhom18_DoAnThucHanh_19HTT2_1.dbo.TAIXE
ADD CONSTRAINT FK_TAIXE_KVHD FOREIGN KEY (KHUVUCHD) REFERENCES dbo.KhuVucHoatDong (MAKHUVUC)
GO

ALTER TABLE Nhom18_DoAnThucHanh_19HTT2_1.dbo.ChiNhanh WITH NOCHECK
ADD CONSTRAINT FK_ChiNhanh_KVHD FOREIGN KEY (DiaChi) REFERENCES dbo.KhuVucHoatDong (MAKHUVUC)
GO
